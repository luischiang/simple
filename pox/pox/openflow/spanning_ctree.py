...
def calculate_ruleset():
	...
	for sw in switches:
		print >>f, ldict[dpidToStr(sw)] + " " + "200"
	...
	os.system(rsmanagerdir + "run_simple_optimal.sh Dynamic 200")
	...
	os.system("mv " + rulegen + "simple_200Dynamic*.sol " + rulegen + "simple_200Dynamic.sol")
...
def configureRules (connection, lruleset):
	...
	try:
		...
		print "Oops! There is no information about the Sw " +  dpidToStr(connection.dpid) + " in the configuration file"
