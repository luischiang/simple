...
def TopologyHotnet(networkName, ruletype, edgefile):
	...
	os.system("rm /tmp/00*")
	os.system("tcpdump -i lo -w /home/luis/finalmbox/pcap/%s-%s-controller.pcap & > /home/luis/finalmbox/pcap/%s-%s-tcpdumpOut-controller.txt" % (networkName, ruletype, networkName, ruletype) )
	...
	os.system("cat /tmp/00* > /home/luis/finalmbox/pcap/%s-%s-times-controller.txt" % (networkName, ruletype))
...
if __name__ == '__main__':
	...
	if len(sys.argv) != 4:
		print "Usage: ./ThisProgram networkName rulesetType <Topology_xxx>"
